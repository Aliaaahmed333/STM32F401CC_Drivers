 ...
 *                :    analog, alternative fun ) by set direction mode in
 *                :    2 pines that are detected to each pin                 */
/****************************************************************************/
	...
	if (Port_Id > PORTH || Pin_Num > PIN15 || AlternativeNum > AF15)
		...
		else
		{
			if (Pin_Num < PIN7)
			{
				switch (Port_Id)
			      {
				      case  PORTA:MODIFY_REG(GPIOA->AFRL ,(AlternativeNum << (Pin_Num %8)*4),(15 <<Pin_Num *4));
				             break;
				      case  PORTB: MODIFY_REG(GPIOB->AFRL ,(AlternativeNum << (Pin_Num %8)*4),(15 <<Pin_Num *4));
					            break;
					  case  PORTC: MODIFY_REG(GPIOC->AFRL ,(AlternativeNum << (Pin_Num %8)*4),(15 <<Pin_Num *4));
					          break;
					  case  PORTD:MODIFY_REG(GPIOD->AFRL ,(AlternativeNum << (Pin_Num %8)*4),(15 <<Pin_Num *4));
					            break;
					  case  PORTE: MODIFY_REG(GPIOE->AFRL ,(AlternativeNum << (Pin_Num %8)*4),(15 <<Pin_Num *4));
					            break;
					  case  PORTH: MODIFY_REG(GPIOH->AFRL ,(AlternativeNum << (Pin_Num %8)*4),(15 <<Pin_Num *4));
					    	     break;
